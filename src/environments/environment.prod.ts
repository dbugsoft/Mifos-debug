...
import env from './.env';
import { getCoopConfig } from './coop-config';
...
export const environment = {
  ...
  fineractPlatformTenantId: loadedEnv['fineractPlatformTenantId'] || getCoopConfig().tenantId,
  fineractPlatformTenantIds: loadedEnv['fineractPlatformTenantIds'] || 'default',
  // Display name of the coop resolved from the current hostname (see coop-config.ts)
  coopName: getCoopConfig().coopName,
